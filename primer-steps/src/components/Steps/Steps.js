...
const Steps = forwardRef(({ ...props }, ref) => {
    const { className, activeStep = 0, children, orientation: orientationProp, state, responsive, checkIcon, onClickStep, labelOrientation, ...rest } = props;
    ...
    return (_jsx(Box, { sx: {
            ...
            flexDirection: 'column',
        }, children: _jsxs(StepsProvider, { value: {
                activeStep,
                orientation,
                state,
                responsive,
                ...
                stepCount,
                className,
            }, children: [_jsx(OrderedList, { as: "ol", 
                    // @ts-ignore
                    ref: ref, className: classnames('primer-steps', className), orientation: orientation, stepCount: stepCount, ...rest, children: React.Children.map(children, (child, i) => {
